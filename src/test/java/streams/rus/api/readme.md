...
Так же этот пример можно найти на [github](https://github.com/Vedenin/java_in_examples/blob/master/stream_api/src/com/github/stream/rus/stream_api/BuildTests.java)'e
